...
def plot_figure4():
    ...
    # Prepare subplot labels and subtitles for bottom placement
    subplot_info = [
        ("a", "South Indian Ocean Basin"),
        ("b", "Northwest Pacific Ocean Basin"),
        ("c", "South Pacific Ocean Basin"),
    ...
    for i, (df, basin) in enumerate(zip(dataframes, basins)):
        ...
        # Determine max category per cyclone, count by decade
        ...
        # Place subplot label and subtitle at bottom
